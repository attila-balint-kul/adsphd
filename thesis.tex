% \documentclass[showinstructions,faculty=firw,department=elt,phddegree=elt]{adsphd}
\documentclass[showinstructions,faculty=firw,department=elt,phddegree=elt,doctoralschool=ads]{adsphd}
%\documentclass[showinstructions,showlabels,coverfontpercent=100,faculty=firw,department=elt,phddegree=elt]{adsphd}
%\documentclass[croppedpdf,showinstructions,faculty=firw,department=elt,phddegree=elt]{adsphd}
%\documentclass[online,faculty=firw,department=elt,phddegree=elt]{adsphd}
%\documentclass[print,bleed,cropmarks,faculty=firw,department=elt,phddegree=elt]{adsphd} % include bleed for the print service
%\documentclass[print,faculty=firw,department=elt,phddegree=elt]{adsphd}
%\documentclass[final,faculty=firw,department=elt,phddegree=elt]{adsphd}
%\documentclass[showinstructions,faculty=firw,department=elt,phddegree=elt,epub]{adsphd}
...
%%% COVER: Settings %%%
\title{Optimal design and operation of pv-battery systems for flexibility}
%\subtitle{Multiscale computing for Dummies}

\author{Attila}{Bálint}

\supervisor{Prof.~dr.~ir.~J.~Driesen}{}
\supervisor{Prof.~dr.~ir.~H.~Kazmi}{}
